...
class LatestOnlyWorker(QObject):
    ...
    # Signals
    finished = Signal(bool, object, str, str)  # result, data, task_id, workload_id
    progress = Signal(int, str, str)  # progress percentage, workload_id, status
    error = Signal(str, str)  # error_message, workload_id
