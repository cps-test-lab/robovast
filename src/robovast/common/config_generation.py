...
from .errors import AuxContainerUnavailable, ExecPathUnavailable, missing_input_error
...
def _check_sim_against_world(execution, configs, vast_dir, scenario_parameters=None):
    ...
    for block, sharing in by_block.values():
        ...
        try:
            ...
            # but with no second attempt to make: nothing can ask a container anything here,
            # so describing the world again without the overrides fails the same way.
