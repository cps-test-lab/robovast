...
class NavMCPPlugin:
    ...
    analysis (trajectory), and environment/map tools.
    """
    ...
    instructions = (
        "Where the robot went: `nav_get_trajectory`, `nav_get_map_info` and "
        "`nav_get_action_feedback` answer it over every recorded pose. Ask them before "
        "writing SQL, which over a thinned or unjoined result gives a different number.")
