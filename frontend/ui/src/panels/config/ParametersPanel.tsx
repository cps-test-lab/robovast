...
//
// The YAML is the whole panel. Not a toggle for the `_`-prefixed internals a variation writes for
// other readers, and not the per-variation previews (each factor's value list, with this
// configuration's value marked): both would restate, in a second notation, what the file beside
// them already says. The column is narrow and shared with the geometry panels, so the space costs
// more than the restatement is worth.
