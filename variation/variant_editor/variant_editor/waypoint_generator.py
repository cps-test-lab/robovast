...
class WaypointGenerator:
    ...
    def __init__(self, map_file_path: str, seed: int = None):
        """
        Initialize waypoint generator with a map file.

        Args:
            map_file_path: Path to the map YAML file
            seed: Random seed for reproducible waypoint generation
        """
    ...
    def generate_waypoints(
        ...
        for x, y in waypoints:
            ...
            result.append(Pose(position=Position(x=x, y=y), yaw=yaw))
        return result
