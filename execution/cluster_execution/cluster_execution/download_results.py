...
Usage: python download_results.py --output <output_directory>
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  %(prog)s --output ./downloaded_results                  # Download all runs (resume if interrupted)
  %(prog)s --output ./downloaded_results --force          # Force re-download all runs
...
def main():
    ...
    if not args.list and not args.output:
        print("Error: --output parameter is required for download mode")
    ...
    try:
        ...
        if args.list:
            ...
            downloader.download_results(args.output, args.force)
