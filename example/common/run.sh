...
if [ -e /config/scenario.variant ]; then
    ros2 run scenario_execution scenario_execution -o /out /config/scenario.osc --scenario-parameter-file /config/scenario.variant
else
    ros2 run scenario_execution scenario_execution -o /out /config/scenario.osc 
fi